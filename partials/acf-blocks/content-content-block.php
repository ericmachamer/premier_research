<div class="content-block-holder">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 <?php if(get_field('enable_sidebar')) { ?>col-lg-8 <?php } ?>
            content-columns animate">
                            ...
                            if( get_row_layout() == 'content_block' ) {
                                ...
                                if( have_rows('image_bullets') ) {
                                    while ( have_rows('image_bullets') ) {
                                        the_row();
                                        ?>
                                        <div class="col-12 col-md-6 col-lg-4 image-bullet-content animate">
                                            <div class="bullet">
                                                <?php
                                                    $image = get_sub_field('image');
            ...
            <div class="col-4 d-none d-lg-block sidebar animate">
                <div class="row">
                <?php
                    $runs = 0;
                    foreach ($sidebar_images as $si) {
                        ...
                        $image_url = wp_get_attachment_image_src($image, $size);
                    ?>
                        <div class="col-12 image-block image-block-sidebar">
                            <?php
                            ...
                            ?>
                            <div class="below-image animate <?php if(!$image_url) { echo 'no-image'; } ?>">
