...
<div class="one-column-bg contact-block <?= get_field('text_color_override'); ?><?php if(get_field('background')['use_paralax_scrolling'] === true) { echo ' paralax'; } ?>" style="background-image: url('<?= $background_image[0]; ?>');">
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-7 col-xl-6 col-xxl-7 text-md-left<?php if(get_field('text_alignment') === 'text-right') { ?> order-last<?php } ?> text-center">
            ...
            <div class="col-12 col-md-5 col-xl-6 col-xxl-5 contact-block-image text-center animate animate-bounce">
                <?php
